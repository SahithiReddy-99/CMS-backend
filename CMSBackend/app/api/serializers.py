...
from app.models import FlatOwner, Block, Flat, Bill, Reciept, Roles, Employees, Visitors


class FlatOwnerSerializer(serializers.ModelSerializer):
    class Meta:
        model = FlatOwner
        fields = ['name', 'mobileNo', 'email', 'address', 'username']
...
class FlatSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Flat
        fields = ['id', 'name', 'description', 'type', 'address', 'blockId', 'ownerId']
...
class EmployeesSerializer(serializers.ModelSerializer):
    roleId = RolesSerializer(read_only=True, many=True)
